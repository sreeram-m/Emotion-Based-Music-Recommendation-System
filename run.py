...
client_credentials_manager = SpotifyClientCredentials(client_id= '171c6cc101c4499999c82ae27eaf8de9', client_secret='f7e01f884f23499b924578b0d858d5df')
...
photo = PhotoImage(file=r"E:\8th Sem\TARP\MRS\images\music.jpg")
...
name_label = tk.Label(root, text='Enter The Artist Name',
                      font=('calibre',
                            10, 'bold'))
...
image1 = Image.open(r"E:\8th Sem\TARP\MRS\images\musicimg (1).jpg")
